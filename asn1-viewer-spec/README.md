...
Have you ever seen any x509 certificates? I hope so. If not, then here is an example:
...
If you decode the base64 data, then you will get the asn1 encoded structure that describes the x509 certificate. You can use these tools to visualize the asn1 data:
...
Basically, you need to write a similar asn1 data visualizer, but for the terminal. You can take the [jless](https://github.com/PaulJuliusMartinez/jless) as an inspiration.

## Functional requirements

* Visualize asn1 data in terminal. It should support nested structures of any complexity (structure inside of the structure, which inside of the structure, ...).
* Visualization should be interactive:
  * The user should be able to hide/open structure fields.
